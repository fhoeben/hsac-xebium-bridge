...
use nl.hsac.fitnesse.fixture.slim.web.xebium.HsacSeleniumDriverFixture instead of com.xebia.incubator.xebium.SeleniumDriverFixture (which will also (like BrowserTest) use the Selenium browser created in the SuiteSetUp).
